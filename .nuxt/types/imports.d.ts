...
export {}
declare global {
  const { $nav_developer_documentation, $nav_router }: typeof import('../../utils/router')
  ...
  const { changeTheme, isDarkModeVuetify, toggleThemeVuetify }: typeof import('../../utils/vuetify')
  ...
  const { copyToClipboard, formatIntl, getGravatarUrl, getRandomNumber, handleDownloadFile, handleOpenJSONinBlob, isValidUrl, projectName, stringToSlug }: typeof import('../../utils/index')
  const { customDate, dateTime, dateTimeSeconds, getDifference, getTime, moment }: typeof import('../../utils/dateFormats')
  ...
  const { externalApiAxios, refreshUserDataLogged }: typeof import('../../utils/axios')
  ...
  const { useStore }: typeof import('../../stores/index')
}
// for type re-export
declare global {
  // @ts-ignore
